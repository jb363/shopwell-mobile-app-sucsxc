    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.card}>
        ...
        <Text style={styles.description}>
          The product search feature is part of the ShopWell.ai website loaded in the home tab.
        </Text>
        <Text style={styles.description}>
          Please navigate to the home tab to access search and all website features.
        </Text>
      </View>
